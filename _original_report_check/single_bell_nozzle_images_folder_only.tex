...
% ---------------------------------------------------------
% Code listings
% Keep minted only if code excerpts are still used.
% If no code remains in the final article, this package can be removed.
% ---------------------------------------------------------
\usepackage{minted}
...
\author{
Rafael Lino$^{1,2}$ and Francisco Ferreira$^{1,2}$\\[3pt]
...
The formulation is further extended toward genetic optimization by introducing geometry-dependent objective and penalty terms, including exit-flow divergence, boundary-layer blockage, curvature-based turning severity, nozzle length, and expansion matching. The objective of the framework is not to replace high-fidelity CFD or experimental qualification, but to provide a fast, interpretable, and physically constrained preliminary design tool for comparing and optimizing bell nozzle geometries.
\end{onecolabstract}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/cad5.png}{\includegraphics[width=0.75\linewidth]{Images/cad5.png}}{\fbox{\parbox{0.75\linewidth}{\centering Missing figure file: \texttt{cad5.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/ex24.png}{\includegraphics[width=0.82\linewidth]{Images/ex24.png}}{\fbox{\parbox{0.82\linewidth}{\centering Missing figure file: \texttt{ex24.png} or replace with the Mach/pressure/temperature axial plot generated by the simulator.}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/ex19.png}{\includegraphics[width=0.82\linewidth]{Images/ex19.png}}{\fbox{\parbox{0.82\linewidth}{\centering Missing figure file: \texttt{ex19.png}}}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{Images/ex20.png}{\includegraphics[width=\linewidth]{Images/ex20.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex20.png}}}}
        \caption{Example exhaust velocity trend.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{Images/ex21.png}{\includegraphics[width=\linewidth]{Images/ex21.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex21.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/ex23.png}{\includegraphics[width=0.82\linewidth]{Images/ex23.png}}{\fbox{\parbox{0.82\linewidth}{\centering Missing figure file: \texttt{Images/ex23.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/RPE.png}{\includegraphics[width=0.82\linewidth]{Images/RPE.png}}{\IfFileExists{Images/RPE (1).png}{\includegraphics[width=0.82\linewidth]{Images/RPE (1).png}}{\fbox{\parbox{0.82\linewidth}{\centering Missing figure file: \texttt{RPE.png} or \texttt{RPE (1).png}}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/autocad1.png}{\includegraphics[width=0.72\linewidth]{Images/autocad1.png}}{\fbox{\parbox{0.72\linewidth}{\centering Missing figure file: \texttt{autocad1.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/SupCad.png}{\includegraphics[width=0.82\linewidth]{Images/SupCad.png}}{\fbox{\parbox{0.82\linewidth}{\centering Missing figure file: \texttt{SupCad.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/cad3.png}{\includegraphics[width=0.75\linewidth]{Images/cad3.png}}{\fbox{\parbox{0.75\linewidth}{\centering Missing figure file: \texttt{cad3.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/plot2D.png}{\includegraphics[width=0.78\linewidth]{Images/plot2D.png}}{\fbox{\parbox{0.78\linewidth}{\centering Missing figure file: \texttt{plot2D.png}}}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{Images/ex2.png}{\includegraphics[width=\linewidth]{Images/ex2.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex2.png}}}}
        \caption{First geometry example.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{Images/ex3.png}{\includegraphics[width=\linewidth]{Images/ex3.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex3.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/ex4.png}{\includegraphics[width=0.88\linewidth]{Images/ex4.png}}{\fbox{\parbox{0.88\linewidth}{\centering Missing figure file: \texttt{ex4.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/ex10.png}{\includegraphics[width=0.88\linewidth]{Images/ex10.png}}{\fbox{\parbox{0.88\linewidth}{\centering Missing figure file: \texttt{ex10.png}}}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{Images/ex11.png}{\includegraphics[width=\linewidth]{Images/ex11.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex11.png}}}}
        \caption{Overdefined sketch irregularity.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{Images/ex12.png}{\includegraphics[width=\linewidth]{Images/ex12.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex12.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/ex13.png}{\includegraphics[width=0.85\linewidth]{Images/ex13.png}}{\fbox{\parbox{0.85\linewidth}{\centering Missing figure file: \texttt{ex13.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{Images/ex14.png}{\includegraphics[width=0.82\linewidth]{Images/ex14.png}}{\fbox{\parbox{0.82\linewidth}{\centering Missing figure file: \texttt{ex14.png}}}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{Images/ex16.png}{\includegraphics[width=\linewidth]{Images/ex16.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex16.png}}}}
        \caption{Wall-thickness offset.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{Images/ex17.png}{\includegraphics[width=\linewidth]{Images/ex17.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex17.png}}}}
