%=================================================================
% MDPI-style manuscript version generated from the reorganized nozzle article
% Source structure: MDPI template + original simulator article + genetic algorithm formulation
%=================================================================
...
%=================================================================
% Additional packages required by the manuscript figures/equations
%=================================================================
\usepackage{siunitx}
\sisetup{per-mode=symbol,detect-all=true,separate-uncertainty=true}
\usepackage{bm}
...
% Fallback helper for figure files that may not yet be uploaded to Overleaf.
\newcommand{\missingfigurebox}[1]{\fbox{\parbox{0.75\linewidth}{\centering Missing figure file: \texttt{#1}}}}

%=================================================================
% Full title of the paper
%=================================================================
\Title{Single Bell Nozzle Geometry and Analysis Simulator}

% Authors
\Author{Rafael Lino $^{1,2}$}
\AuthorNames{Rafael Lino}

% Affiliations
\address{%
$^{1}$ \quad Porto Space Team, Faculty of Engineering, University of Porto, Porto, Portugal\\
$^{2}$ \quad Department of Mechanical Engineering, Faculty of Engineering, University of Porto, Porto, Portugal}

% Corresponding author
\corres{Correspondence: aerolagarto@gmail.com}

% Abstract
\abstract{This work presents the formulation and development of a computational simulator for the geometric generation and preliminary analysis of single bell nozzles for hybrid rocket propulsion systems. The simulator supports fast nozzle sizing, two-dimensional contour generation, three-dimensional visualization, coordinate export to CAD software, and preliminary performance estimation based on thermochemical data and quasi-one-dimensional nozzle relations. The nozzle contour follows a classical bell geometry inspired by the Rao--Sutton approach, combining a converging subsonic section, a rounded throat region, a short supersonic circular arc, and a parabolic diverging contour. From a reduced set of geometric variables, the simulator constructs a continuous piecewise contour and evaluates secondary geometric quantities such as contraction ratio, nozzle length, exit radius, and parabolic exit angle. The baseline flow model assumes steady, adiabatic, quasi-one-dimensional, inviscid, shock-free expansion. Thermochemical properties are obtained from NASA CEA through RocketCEA, while the axial Mach number and thermodynamic distributions are determined from the area--Mach relation and the classical isentropic relations. This ideal framework is extended with simplified geometric and viscous loss models suitable for integration into a genetic optimization algorithm, including exit divergence losses, boundary-layer blockage effects, and curvature-based turning penalties.}

% Keywords
\keyword{bell nozzle; hybrid rocket engine; nozzle geometry; isentropic flow; RocketCEA; boundary layer; genetic algorithm; propulsion optimization}
...
\begin{figure}[H]
    \centering
    \IfFileExists{image.png}{\includegraphics[width=0.55\linewidth]{image.png}}{\fbox{\parbox{0.55\linewidth}{\centering Missing figure file: \texttt{image.png}}}}
    \caption{Original simulator interface buttons and available functionalities.}
    \label{fig:interface_buttons}
\end{figure}
...
\subsection{Baseline Physical and Thermochemical Model Without Boundary Layer}
% =========================================================
...
\subsubsection{Thermochemical input from NASA CEA and RocketCEA}
...
\subsubsection{Choked-flow relation and throat sizing}
...
\begin{figure}[H]
    \centering
    \IfFileExists{cad5.png}{\includegraphics[width=0.75\linewidth]{cad5.png}}{\fbox{\parbox{0.75\linewidth}{\centering Missing figure file: \texttt{cad5.png}}}}
    \caption{Nozzle flow stations used for throat sizing and ideal one-dimensional analysis.}
    \label{fig:flow_stations}
\end{figure}

\subsubsection{Thrust equation and ideal expansion condition}
...
\subsubsection{Expansion ratio and exit radius}
...
\subsubsection{Oxidizer-to-fuel ratio and total propellant mass flow}
...
% =========================================================
\subsection{Quasi-One-Dimensional Isentropic Flow Along the Nozzle}
% =========================================================
...
\subsubsection{Numerical determination of Mach number}
...
\subsubsection{Mach, pressure and temperature trends}
...
% =========================================================
\subsection{Bell-Nozzle Geometric Formulation}
% =========================================================
...
\begin{figure}[H]
    \centering
    \IfFileExists{RPE.png}{\includegraphics[width=0.82\linewidth]{RPE.png}}{\IfFileExists{RPE (1).png}{\includegraphics[width=0.82\linewidth]{RPE (1).png}}{\fbox{\parbox{0.82\linewidth}{\centering Missing figure file: \texttt{RPE.png} or \texttt{RPE (1).png}}}}}
    \caption{Reference bell nozzle geometry model from the Sutton/Biblarz formulation.}
    \label{fig:RPE_geometry}
\end{figure}

\subsubsection{General piecewise structure}
...
\subsubsection{Subsonic circular arc}
...
\begin{figure}[H]
    \centering
    \IfFileExists{autocad1.png}{\includegraphics[width=0.72\linewidth]{autocad1.png}}{\fbox{\parbox{0.72\linewidth}{\centering Missing figure file: \texttt{autocad1.png}}}}
    \caption{Subsonic geometric relations and definition of the converging arc.}
    \label{fig:subsonic_geometry}
\end{figure}

\subsubsection{Initial straight converging line}
...
\subsubsection{Supersonic circular arc}
...
\begin{figure}[H]
    \centering
    \IfFileExists{SupCad.png}{\includegraphics[width=0.82\linewidth]{SupCad.png}}{\fbox{\parbox{0.82\linewidth}{\centering Missing figure file: \texttt{SupCad.png}}}}
    \caption{Supersonic throat arc and transition into the parabolic diverging contour.}
    \label{fig:supersonic_geometry}
\end{figure}

\subsubsection{Reference conical length and bell length}
...
\subsubsection{Parabolic supersonic contour}
...
\subsubsection{Complete piecewise geometry function}
...
% =========================================================
\subsection{Geometric Parameters and Notation Overview}
% =========================================================
...
% =========================================================
\subsection{Coordinate Translation and Two-Dimensional Geometry Output}
% =========================================================
...
\begin{figure}[H]
    \centering
    \IfFileExists{cad3.png}{\includegraphics[width=0.75\linewidth]{cad3.png}}{\fbox{\parbox{0.75\linewidth}{\centering Missing figure file: \texttt{cad3.png}}}}
    \caption{Horizontal translation used to move the nozzle start to $x=0$.}
    \label{fig:translation}
\end{figure}

\subsubsection{Secondary geometric outputs}
...
\begin{figure}[H]
    \centering
    \IfFileExists{plot2D.png}{\includegraphics[width=0.78\linewidth]{plot2D.png}}{\fbox{\parbox{0.78\linewidth}{\centering Missing figure file: \texttt{plot2D.png}}}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{ex2.png}{\includegraphics[width=\linewidth]{ex2.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex2.png}}}}
        \caption{First geometry example.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{ex3.png}{\includegraphics[width=\linewidth]{ex3.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex3.png}}}}
...
% =========================================================
\subsection{Three-Dimensional Geometry Generation}
% =========================================================
...
\subsubsection{Three-dimensional visualization}
...
\begin{figure}[H]
    \centering
    \IfFileExists{ex4.png}{\includegraphics[width=0.88\linewidth]{ex4.png}}{\fbox{\parbox{0.88\linewidth}{\centering Missing figure file: \texttt{ex4.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{ex10.png}{\includegraphics[width=0.88\linewidth]{ex10.png}}{\fbox{\parbox{0.88\linewidth}{\centering Missing figure file: \texttt{ex10.png}}}}
    \caption{Example of multi-view visualization of the generated nozzle geometry.}
    \label{fig:3D_multiview}
\end{figure}

% =========================================================
\subsection{CAD Export and Manufacturing-Oriented Geometry}
% =========================================================

\subsubsection{Coordinate export}
...
\subsubsection{Point reduction and filtering}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{ex11.png}{\includegraphics[width=\linewidth]{ex11.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex11.png}}}}
        \caption{Overdefined sketch irregularity.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{ex12.png}{\includegraphics[width=\linewidth]{ex12.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex12.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{ex13.png}{\includegraphics[width=0.85\linewidth]{ex13.png}}{\fbox{\parbox{0.85\linewidth}{\centering Missing figure file: \texttt{ex13.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{ex14.png}{\includegraphics[width=0.82\linewidth]{ex14.png}}{\fbox{\parbox{0.82\linewidth}{\centering Missing figure file: \texttt{ex14.png}}}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{ex16.png}{\includegraphics[width=\linewidth]{ex16.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex16.png}}}}
        \caption{Wall-thickness offset.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{ex17.png}{\includegraphics[width=\linewidth]{ex17.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex17.png}}}}
...
% =========================================================
\subsection{Ideal Expansion Ratio and Preliminary Performance Analysis}
% =========================================================

\subsubsection{Ideal expansion ratio search}
...
\begin{figure}[H]
    \centering
    \IfFileExists{ex19.png}{\includegraphics[width=0.82\linewidth]{ex19.png}}{\fbox{\parbox{0.82\linewidth}{\centering Missing figure file: \texttt{ex19.png}}}}
    \caption{Example output for ideal expansion ratio estimation.}
    \label{fig:ideal_expansion_result}
\end{figure}

\subsubsection{Exhaust velocity and temperature}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{ex20.png}{\includegraphics[width=\linewidth]{ex20.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex20.png}}}}
        \caption{Example exhaust velocity trend.}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\linewidth}
        \centering
        \IfFileExists{ex21.png}{\includegraphics[width=\linewidth]{ex21.png}}{\fbox{\parbox{0.95\linewidth}{\centering Missing: \texttt{ex21.png}}}}
...
\begin{figure}[H]
    \centering
    \IfFileExists{ex23.png}{\includegraphics[width=0.82\linewidth]{ex23.png}}{\fbox{\parbox{0.82\linewidth}{\centering Missing figure file: \texttt{ex23.png}}}}
    \caption{Example performance-parameter output table and plot.}
    \label{fig:performance_parameters}
\end{figure}

% =========================================================
\subsection{Boundary-Layer and Geometric-Loss Extension for Optimization}
% =========================================================

\subsubsection{Why the ideal model is not enough for optimization}
...
\subsubsection{Exit flow divergence losses}
...
\subsubsection{Boundary-layer blockage}
...
\subsubsection{Curvature-based turning loss}
...
\subsubsection{Interpretation of optimization results}
...
\subsection{Three-dimensional preview}
...
\subsection{Ideal performance trends}
...
\subsection{Need for corrected optimization model}
...
\noindent\textbf{Author Contributions:} Conceptualization, R.L.; methodology, R.L.; software, R.L.; formal analysis, R.L.; investigation, R.L.; visualization, R.L.; writing---original draft preparation, R.L.; writing---review and editing, R.L.; project administration, R.L.
...
\noindent\textbf{Data Availability Statement:} The simulator source files, generated coordinate tables and internal plots are project material of the Porto Space Team and may be made available upon reasonable request, subject to project restrictions.


\noindent\textbf{Acknowledgments:} The author acknowledges the Porto Space Team Propulsion Department and the Faculty of Engineering of the University of Porto for the technical context in which this work was developed.
...
PST & Porto Space Team\\
RPE & Rocket Propulsion Elements\\
\end{tabular}
}
...
\bibitem[Sutton and Biblarz(2017)]{SuttonBiblarz}
Sutton, G.P.; Biblarz, O. \textit{Rocket Propulsion Elements}, 9th ed.; Wiley: Hoboken, NJ, USA, 2017.

\bibitem[Gordon and McBride(1994)]{NASA_CEA}
Gordon, S.; McBride, B.J. \textit{Computer Program for Calculation of Complex Chemical Equilibrium Compositions and Applications}; NASA Reference Publication 1311; NASA: Washington, DC, USA, 1994.

\bibitem[DeLong]{RocketCEA}
DeLong, C.E. \textit{RocketCEA Documentation}; Python interface for NASA CEA.

\bibitem[Rao(1958)]{RaoBellNozzle}
Rao, G.V.R. Exhaust nozzle contour for optimum thrust. \textit{Jet Propulsion} \textbf{1958}, \textit{28}, 377--382.

\bibitem[Anderson]{Anderson}
Anderson, J.D. \textit{Modern Compressible Flow: With Historical Perspective}; McGraw--Hill: New York, NY, USA.

\bibitem[Shapiro]{Shapiro}
Shapiro, A.H. \textit{The Dynamics and Thermodynamics of Compressible Fluid Flow}; Ronald Press: New York, NY, USA.

\bibitem[Schlichting and Gersten]{Schlichting}
Schlichting, H.; Gersten, K. \textit{Boundary-Layer Theory}; Springer: Berlin/Heidelberg, Germany.

\bibitem[White]{WhiteViscous}
White, F.M. \textit{Viscous Fluid Flow}; McGraw--Hill: New York, NY, USA.

\bibitem[Goldberg(1989)]{GoldbergGA}
Goldberg, D.E. \textit{Genetic Algorithms in Search, Optimization, and Machine Learning}; Addison--Wesley: Boston, MA, USA, 1989.

\bibitem[Deb(2001)]{DebOptimization}
Deb, K. \textit{Multi-Objective Optimization Using Evolutionary Algorithms}; Wiley: Chichester, UK, 2001.

\bibitem[Hunter(2007)]{Hunter}
Hunter, J.D. Matplotlib: A 2D graphics environment. \textit{Computing in Science \& Engineering} \textbf{2007}, \textit{9}, 90--95.

\bibitem[Harris et al.(2020)]{Harris}
Harris, C.R.; Millman, K.J.; van der Walt, S.J.; et al. Array programming with NumPy. \textit{Nature} \textbf{2020}, \textit{585}, 357--362.

\bibitem[MDPI Template]{MDPITemplate}
MDPI. \textit{MDPI LaTeX Template and Author Instructions}.

\bibitem[Porto Space Team]{PST}
Porto Space Team. \textit{INVICTUS Project Internal Development Material}; Faculty of Engineering, University of Porto.

\bibitem[Lino(2025)]{ArticleDraft}
Lino, R. \textit{Single Bell Nozzle Geometry and Analysis Simulator}; Original manuscript draft, 2025.

\bibitem[Lino(2026)]{OptimizationDraft}
Lino, R. \textit{Genetic Algorithm Formulation for Bell Nozzle Geometry Optimization}; Internal draft, 2026.

\bibitem[Autodesk]{Fusion}
Autodesk. \textit{Autodesk Fusion Documentation}.

\bibitem[Dassault Systèmes]{SolidWorks}
Dassault Systèmes. \textit{SOLIDWORKS Documentation}.

\bibitem[Feuersänger]{PGFPlots}
Feuersänger, C. \textit{Manual for Package PGFPlots}.

\bibitem[Tantau]{TikZ}
Tantau, T. \textit{The TikZ and PGF Packages Manual}.

\bibitem[Shafranovich(2005)]{CSV}
Shafranovich, Y. Common Format and MIME Type for Comma-Separated Values Files; RFC 4180, 2005.

\bibitem[Rafael Lino]{CurrentManuscript}
Lino, R. \textit{Single Bell Nozzle Geometry and Analysis Simulator---MDPI Formatting Draft}; Current manuscript, 2026.

\bibitem[Rafael Lino]{CurrentFinalOverleaf}
Lino, R. \textit{Current Final Overleaf-Ready Source for MDPI-Formatted Single Bell Nozzle Article}; Internal material, 2026.

\bibitem[Rafael Lino]{CurrentFinalSectionMap}
Lino, R. \textit{Current Final Section Map for MDPI-Formatted Nozzle Article}; Internal material, 2026.

\bibitem[Rafael Lino]{CurrentFinalFigureMap}
Lino, R. \textit{Current Final Figure Map for MDPI-Formatted Nozzle Article}; Internal material, 2026.

\bibitem[Rafael Lino]{MDPIConversion}
Lino, R. \textit{MDPI LaTeX Conversion Notes and Section Consolidation for the Single Bell Nozzle Article}; Internal draft, 2026.

\bibitem[Rafael Lino]{FigureSelection}
Lino, R. \textit{Recommended Figure Selection for Single Bell Nozzle Article}; Internal draft, 2026.

\bibitem[Rafael Lino]{GANotes}
Lino, R. \textit{Genetic Algorithm Formulation Notes for Bell Nozzle Geometry Optimization}; Internal draft, 2026.

\bibitem[Rafael Lino]{BLCorrectionNotes}
Lino, R. \textit{Boundary-Layer Correction Notes for Nozzle Optimization}; Internal material, 2026.

\bibitem[Rafael Lino]{CADExportNotes}
Lino, R. \textit{CAD Export and Manufacturing Geometry Records for Single Bell Nozzle Simulator}; Internal material, 2026.

\bibitem[Rafael Lino]{PerformancePlotArchive}
Lino, R. \textit{Nozzle Performance Plot Archive}; Internal figure set, 2026.

\bibitem[Rafael Lino]{CurrentFinalCompleteSource}
Lino, R. \textit{Current Final Complete Source for MDPI-Formatted Single Bell Nozzle Geometry and Analysis Simulator}; Internal material, 2026.

\bibitem[Rafael Lino]{CurrentFinalTXT}
Lino, R. \textit{Current Final TXT Containing LaTeX Source for MDPI-Formatted Single Bell Nozzle Article}; Internal material, 2026.

\bibitem[Rafael Lino]{CurrentFinalTEX}
Lino, R. \textit{Current Final TEX Source for MDPI-Formatted Single Bell Nozzle Article}; Internal material, 2026.

\bibitem[Rafael Lino]{CurrentUserRequest}
Lino, R. \textit{Current User Request: MDPI Formatting and Section Consolidation}; Internal material, 2026.

\bibitem[Rafael Lino]{CurrentFinalDelivery}
Lino, R. \textit{Current Final Delivery Notes for MDPI-Formatted Single Bell Nozzle Article}; Internal material, 2026.

\bibitem[Rafael Lino]{CurrentFinalArticle}
Lino, R. \textit{Current Final Article Source for MDPI-Formatted Single Bell Nozzle Geometry and Analysis Simulator}; Internal material, 2026.

\bibitem[Rafael Lino]{CurrentFinalCompleteVersion}
Lino, R. \textit{Current Final Complete Version of the MDPI-Formatted Single Bell Nozzle Geometry and Analysis Simulator}; Internal material, 2026.

\bibitem[Rafael Lino]{CurrentFinalCompleteOverleaf}
Lino, R. \textit{Current Final Complete Overleaf Source for MDPI-Formatted Single Bell Nozzle Geometry and Analysis Simulator}; Internal material, 2026.

\bibitem[Rafael Lino]{CurrentFinalCompleteTXT}
Lino, R. \textit{Current Final Complete TXT Source for MDPI-Formatted Single Bell Nozzle Geometry and Analysis Simulator}; Internal material, 2026.

\bibitem[Rafael Lino]{CurrentFinalCompleteTEX}
Lino, R. \textit{Current Final Complete TEX Source for MDPI-Formatted Single Bell Nozzle Geometry and Analysis Simulator}; Internal material, 2026.
